...
<div id="drag-and-drop-zone-<?=$item['size']?>" class="uploader">
    ...
    <span class="dnd-size" style="font-size:3rem;"><?=$item['size']?></span>
    ...
    <div class="browser">
        ...
        <div style="margin-top: 0.5rem; font-size: 1.3rem; color: #000;">К печати принимаются только форматы
            <b>JPG</b> и <b>PNG</b>.
    ...
    <div class="mass_control"><a href="javapreview_imagescript:void(0);" class="button btn btn-primary allmate">Все матовые</a><a
                href="javascript:void(0);" class="button btn btn-primary allglossy">Все глянцевые</a></div>
    <div id="fileList-<?=$item['size']?>" class="filelist">
